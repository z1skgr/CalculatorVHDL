# 
# Project automation script for lab3 
# 
# Created for ISE version 13.4
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source lab3.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "AddFSMTest.vhd"
   xfile add "BehCounter.vhd"
   xfile add "COUNTER.vhd"
   xfile add "Coder.vhd"
   xfile add "Comparator_Equality.vhd"
   xfile add "Decoder.vhd"
   xfile add "FSM.vhd"
   xfile add "FSM1.vhd"
   xfile add "FSM2.vhd"
   xfile add "FlipFlop.vhd"
   xfile add "Lab3UCF.ucf"
   xfile add "MUX.vhd"
   xfile add "MUX32x8.vhd"
   xfile add "MUX4v1.vhd"
   xfile add "ModeFsm.vhd"
   xfile add "SSDController.vhd"
   xfile add "SSDFSM.vhd"
   xfile add "Top.vhd"
   xfile add "and_gate.vhd"
   xfile add "behcounttest.vhd"
   xfile add "comparatorTest.vhd"
   xfile add "ipcore_dir/STACK.xco"
   xfile add "modefsmtest.vhd"
   xfile add "singlepulsegen.vhd"
   xfile add "testCounter.vhd"
   xfile add "testDecoder.vhd"
   xfile add "testMux32.vhd"
   xfile add "testSSD.vhd"
   xfile add "testTop.vhd"
   xfile add "testfsm.vhd"
   xfile add "testmux.vhd"
   xfile add "xnor_gate.vhd"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Work Directory" "C:/Xilinx/LABS/LAB3/lab3/xst" -process "Synthesize - XST"
